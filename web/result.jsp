...
<html>
    ...
    <body>
        <h1>The flag of <%= request.getAttribute("flagCountryName")%></h1><br>
        <img src="<%= request.getAttribute("flagImageURL")%>"><br>
        <p><b>About this flag: </b><%= request.getAttribute("flagDescription")%></p><br>
         <form action="FlagServlet" method="GET">
            <p>Choose another country to display their flag</p>
                     <select name="country">			
